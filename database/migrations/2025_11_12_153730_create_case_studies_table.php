...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Creates the case_studies table to store real-world case studies showcasing
     * how our solutions have helped organizations overcome challenges and achieve their goals.
    ...
    public function up(): void
    {
        Schema::create('case_studies', function (Blueprint $table) {
            ...
            $table->boolean('is_active')->default(true)->comment('Whether the case study is active');
