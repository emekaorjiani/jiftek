...
@section('page-description', 'Add a new client testimonial')

@section('content')
<div class="bg-white rounded-lg shadow">
    <form method="POST" action="{{ route('admin.content.testimonials.store') }}" enctype="multipart/form-data" class="p-6">
        @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                placeholder="Client testimonial quote or description">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="content" id="content" rows="8"
                                ...
                                placeholder="Full testimonial content (HTML supported)">{{ old('content') }}</textarea>
                            @error('content')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
