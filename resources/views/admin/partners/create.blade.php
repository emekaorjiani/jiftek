...
@section('page-title', 'Create New Partner (Technologies We Use)')
@section('page-description', 'Add a new technology logo to the Technologies We Use section')

@section('content')
<div class="bg-white rounded-lg shadow">
    <form method="POST" action="{{ route('admin.content.partners.store') }}" enctype="multipart/form-data" class="p-6">
        @csrf
