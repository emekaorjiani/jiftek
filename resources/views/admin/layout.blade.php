                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="{{ route('admin.content.partners') }}" class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.content.partners.*') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
                                ...
                                Partners <span class="text-xs text-gray-400 ml-1">(Technologies We Use)</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.messages') }}" class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.messages.*') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
