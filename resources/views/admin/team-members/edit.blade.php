...
@section('page-description', 'Update team member information')
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $teamMember->title) }}" required
                        ...
                        <div>
                            ...
                            <textarea name="bio" id="bio" rows="5"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('bio', $teamMember->bio) }}</textarea>
                        </div>
