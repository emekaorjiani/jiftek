...
@section('page-title', 'Services Page Content')
@section('page-description', 'Manage the services page content and sections')

@section('content')
<div class="bg-white rounded-lg shadow">
    <form method="POST" action="{{ route('admin.content.services.update') }}" class="p-6">
        @csrf
        @method('PUT')
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $page->meta_title ?? '') }}"
                            ...
                            placeholder="Services - Company Name">
                    </div>
