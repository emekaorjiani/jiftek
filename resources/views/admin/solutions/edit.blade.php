...
@section('page-description', 'Update solution information')
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" value="{{ old('slug', $solution->slug) }}"
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $solution->description) }}</textarea>
                        </div>
                        
                        <div>
                            <label for="content" class="block text-sm font-medium text-gray-700">Content</label>
                            <textarea name="content" id="content" rows="10"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('content', $solution->content) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="icon" id="icon" value="{{ old('icon', $solution->icon) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" name="order" id="order" value="{{ old('order', $solution->order) }}" min="0"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        
                        <div class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $solution->is_active) ? 'checked' : '' }}
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="seo_title" id="seo_title" value="{{ old('seo_title', $solution->seo_title) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="seo_description" id="seo_description" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('seo_description', $solution->seo_description) }}</textarea>
                        </div>
                        
                        <div>
                            <label for="seo_keywords" class="block text-sm font-medium text-gray-700">SEO Keywords</label>
                            <input type="text" name="seo_keywords" id="seo_keywords" value="{{ old('seo_keywords', $solution->seo_keywords) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
