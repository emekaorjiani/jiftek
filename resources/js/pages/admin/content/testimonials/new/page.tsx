...
/**
 * NewTestimonialPage - Admin page for creating/editing testimonials/case studies
 *
 * This component provides a comprehensive form for creating new testimonials
 * with images, client information, results, SEO optimization, and display controls.
 * Supports both create and update modes.
 */
export default function NewTestimonialPage({ testimonial }: { testimonial?: any }) {
  ...
  const handleSubmit: FormEventHandler = (e) => {
    ...
    if (isEditing) {
      put(route('admin.content.testimonials.update', testimonial.id), {
        preserveScroll: true,
      })
    } else {
      post(route('admin.content.testimonials.store'), {
        preserveScroll: true,
      })
    }
  }
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-2">
              ...
              <Link href={route('admin.content.testimonials')}>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  {isEditing ? 'Update your case study' : 'Add a new client success story'}
                </p>
              </div>
            </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="e.g., Financial Services Transformation"
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      Full case study content displayed on the testimonial page. HTML is supported.
                    </p>
                    {errors.content && (
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure testimonial display options</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {/* Order */}
                  <div className="space-y-2">
