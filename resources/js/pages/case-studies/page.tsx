 ...
 *
 * Displays a listing of all case studies.
 * Shows case studies in a grid layout with images and descriptions.
 */
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[700px] text-gray-300 md:text-xl/relaxed">
                Discover how we've helped organizations overcome challenges and achieve their business goals through innovative solutions.
              </p>
            </div>
          </div>
        </div>
                ...
                {caseStudies.map((caseStudy) => (
                  ...
                  >
                    <div className="relative h-60 w-full overflow-hidden">
                      <img
                        src={caseStudy.image || "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1200&h=800&fit=crop&q=80"}
                        alt={caseStudy.title}
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-100 mb-2">{caseStudy.title}</h3>
                      <p className="mt-2 text-gray-300 line-clamp-3">{caseStudy.description}</p>
                      {caseStudy.results && (
