...
/**
 * TestimonialShowPage Component
 *
 * Displays a single testimonial/case study in detail.
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 dark:bg-gradient-to-r dark:from-blue-900 dark:via-blue-800 dark:to-blue-700 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            <Link href="/testimonials" className="inline-flex items-center text-blue-200 hover:text-white mb-6 transition-colors">
                    ...
                    <div className="space-y-4">
                      {testimonial.client_name && (
                        <div>
                          ...
                          <p className="text-base text-gray-900 dark:text-gray-100">{testimonial.client_name}</p>
                        </div>
                      )}
                      {testimonial.client_industry && (
                        <div>
                          <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Industry</p>
                          <p className="text-base text-gray-900 dark:text-gray-100">{testimonial.client_industry}</p>
                        </div>
                      )}
                    </div>
                  </div>
